...
INSERT INTO users (id, f_name, l_name, email, contact_no, hash_pwd, user_type) VALUES
-- Current students (2023)
    ('TG/2023/1780', 'Nimal', 'Perera', 'nimal.perera@students.tecmis.lk', '0712345678', 'hashed_password_1', 'Undergraduate'),
    ('TG/2023/1781', 'Kamal', 'Fernando', 'kamal.fernando@students.tecmis.lk', '0712345679', 'hashed_password_2', 'Undergraduate'),
    ('TG/2023/1782', 'Sunil', 'Silva', 'sunil.silva@students.tecmis.lk', '0712345680', 'hashed_password_3', 'Undergraduate'),
    ('TG/2023/1783', 'Amara', 'Jayawardena', 'amara.j@students.tecmis.lk', '0712345681', 'hashed_password_4', 'Undergraduate'),
    ('TG/2023/1784', 'Ruwan', 'Rathnayake', 'ruwan.r@students.tecmis.lk', '0712345682', 'hashed_password_5', 'Undergraduate'),
...
VALUES
    -- TG/2023/1780 (Proper student - enrolled in ALL 8 courses)
...
-- Insert exam types (based on unique type_id values from marks table)
...
INSERT INTO course_exam (course_code, type_id, weight, exam_date, exam_name) VALUES
                                                                                 ('ICT2142', 'ASST', 0.20, '2026-03-15', 'Assignment'),
                                                                                 ('ICT2142', 'FINT', 0.70, '2026-06-10', 'Final Theory Exam'),
...
INSERT INTO course_exam (course_code, type_id, weight, exam_date, exam_name) VALUES
                                                                                 ('ICT2122', 'ASST', 0.10, '2026-03-20', 'Assignment'),
                                                                                 ('ICT2122', 'MIDT', 0.10, '2026-04-05', 'Midterm Theory'),
                                                                                 ('ICT2122', 'FINT', 0.70, '2026-06-15', 'Final Theory'),
...
INSERT INTO course_exam (course_code, type_id, weight, exam_date, exam_name) VALUES
                                                                                 ('ICT2132', 'ASST', 0.20, '2026-04-10', 'Project'),
                                                                                 ('ICT2132', 'MIDP', 0.10, '2026-04-20', 'Midterm Practical'),
                                                                                 ('ICT2132', 'FINP', 0.60, '2026-06-20', 'Final Practical'),
...
INSERT INTO course_exam (course_code, type_id, weight, exam_date, exam_name) VALUES
                                                                                 ('ICT2152', 'ASST', 0.20, '2026-03-25', 'E-Commerce Project'),
                                                                                 ('ICT2152', 'MIDT', 0.10, '2026-04-15', 'Midterm Theory'),
                                                                                 ('ICT2152', 'FINT', 0.60, '2026-06-18', 'Final Theory'),
...
-- ENG2122 - English III
INSERT INTO course_exam (course_code, type_id, weight, exam_date, exam_name) VALUES
                                                                                 ('ENG2122', 'ASST', 0.20, '2026-03-30', 'English Assignment'),
                                                                                 ('ENG2122', 'MIDT', 0.10, '2026-04-12', 'Midterm Exam'),
                                                                                 ('ENG2122', 'FINT', 0.60, '2026-06-14', 'Final Exam'),
...
INSERT INTO course_exam (course_code, type_id, weight, exam_date, exam_name) VALUES
                                                                                 ('ICT2113', 'ASST', 0.10, '2026-03-18', 'Assignment'),
                                                                                 ('ICT2113', 'MIDP', 0.20, '2026-04-10', 'Midterm Practical'),
                                                                                 ('ICT2113', 'FINT', 0.60, '2026-06-22', 'Final Theory'),
...
INSERT INTO course_exam (course_code, type_id, weight, exam_date, exam_name) VALUES
                                                                                 ('TCS2112', 'ASST', 0.10, '2026-03-22', 'Economics Assignment'),
                                                                                 ('TCS2112', 'MIDT', 0.10, '2026-04-18', 'Midterm Exam'),
                                                                                 ('TCS2112', 'FINT', 0.70, '2026-06-20', 'Final Exam'),
...
-- TCS2122 - Soft Skills
INSERT INTO course_exam (course_code, type_id, weight, exam_date, exam_name) VALUES
                                                                                 ('TCS2122', 'ASST', 0.10, '2026-03-28', 'Soft Skills Assignment'),
                                                                                 ('TCS2122', 'MIDT', 0.20, '2026-04-22', 'Midterm Assessment'),
                                                                                 ('TCS2122', 'FINT', 0.60, '2026-06-23', 'Final Assessment'),
                                                                                 ('TCS2122', 'QU01', 0.05, '2026-02-28', 'Quiz 1'),
                                                                                 ('TCS2122', 'QU02', 0.05, '2026-03-28', 'Quiz 2'),
                                                                                 ('TCS2122', 'QU03', 0.05, '2026-05-01', 'Quiz 3');

-- Mark ID format: M + stu_id_last4 + course_code_last4 + type_id (but since mark_id is CHAR(12), use a short unique key)
-- Using format: MK + seq number padded

INSERT INTO marks (mark_id, stu_id, course_code, type_id, mark) VALUES

-- ============================================================
-- TG/2023/1780 (Proper - Nimal Perera) - All 8 courses, good student
-- ============================================================
-- ICT2142
('MK000000001', 'TG/2023/1780', 'ICT2142', 'ASST', 82.00),
('MK000000002', 'TG/2023/1780', 'ICT2142', 'FINT', 75.00),
('MK000000003', 'TG/2023/1780', 'ICT2142', 'QU01', 80.00),
('MK000000004', 'TG/2023/1780', 'ICT2142', 'QU02', 78.00),
('MK000000005', 'TG/2023/1780', 'ICT2142', 'QU03', 85.00),

-- ICT2122
('MK000000006', 'TG/2023/1780', 'ICT2122', 'ASST', 88.00),
('MK000000007', 'TG/2023/1780', 'ICT2122', 'MIDT', 72.00),
('MK000000008', 'TG/2023/1780', 'ICT2122', 'FINT', 79.00),
('MK000000009', 'TG/2023/1780', 'ICT2122', 'QU01', 85.00),
('MK000000010', 'TG/2023/1780', 'ICT2122', 'QU02', 82.00),
('MK000000011', 'TG/2023/1780', 'ICT2122', 'QU03', 80.00),

-- ICT2132
('MK000000012', 'TG/2023/1780', 'ICT2132', 'ASST', 90.00),
('MK000000013', 'TG/2023/1780', 'ICT2132', 'MIDP', 84.00),
('MK000000014', 'TG/2023/1780', 'ICT2132', 'FINP', 86.00),
('MK000000015', 'TG/2023/1780', 'ICT2132', 'QU01', 88.00),
('MK000000016', 'TG/2023/1780', 'ICT2132', 'QU02', 85.00),
('MK000000017', 'TG/2023/1780', 'ICT2132', 'QU03', 87.00),

-- ICT2152
('MK000000018', 'TG/2023/1780', 'ICT2152', 'ASST', 76.00),
('MK000000019', 'TG/2023/1780', 'ICT2152', 'MIDT', 68.00),
('MK000000020', 'TG/2023/1780', 'ICT2152', 'FINT', 74.00),
('MK000000021', 'TG/2023/1780', 'ICT2152', 'QU01', 72.00),
('MK000000022', 'TG/2023/1780', 'ICT2152', 'QU02', 70.00),
('MK000000023', 'TG/2023/1780', 'ICT2152', 'QU03', 75.00),

-- ENG2122
('MK000000024', 'TG/2023/1780', 'ENG2122', 'ASST', 85.00),
('MK000000025', 'TG/2023/1780', 'ENG2122', 'MIDT', 78.00),
('MK000000026', 'TG/2023/1780', 'ENG2122', 'FINT', 80.00),
('MK000000027', 'TG/2023/1780', 'ENG2122', 'QU01', 82.00),
('MK000000028', 'TG/2023/1780', 'ENG2122', 'QU02', 79.00),
('MK000000029', 'TG/2023/1780', 'ENG2122', 'QU03', 83.00),

-- ICT2113
('MK000000030', 'TG/2023/1780', 'ICT2113', 'ASST', 77.00),
('MK000000031', 'TG/2023/1780', 'ICT2113', 'MIDP', 71.00),
('MK000000032', 'TG/2023/1780', 'ICT2113', 'FINT', 73.00),
('MK000000033', 'TG/2023/1780', 'ICT2113', 'QU01', 75.00),
('MK000000034', 'TG/2023/1780', 'ICT2113', 'QU02', 74.00),
('MK000000035', 'TG/2023/1780', 'ICT2113', 'QU03', 76.00),

-- TCS2112
('MK000000036', 'TG/2023/1780', 'TCS2112', 'ASST', 80.00),
('MK000000037', 'TG/2023/1780', 'TCS2112', 'MIDT', 75.00),
('MK000000038', 'TG/2023/1780', 'TCS2112', 'FINT', 78.00),
('MK000000039', 'TG/2023/1780', 'TCS2112', 'QU01', 77.00),
('MK000000040', 'TG/2023/1780', 'TCS2112', 'QU02', 79.00),
('MK000000041', 'TG/2023/1780', 'TCS2112', 'QU03', 81.00),

-- TCS2122
('MK000000042', 'TG/2023/1780', 'TCS2122', 'ASST', 83.00),
('MK000000043', 'TG/2023/1780', 'TCS2122', 'MIDT', 76.00),
('MK000000044', 'TG/2023/1780', 'TCS2122', 'FINT', 79.00),
('MK000000045', 'TG/2023/1780', 'TCS2122', 'QU01', 80.00),
('MK000000046', 'TG/2023/1780', 'TCS2122', 'QU02', 78.00),
('MK000000047', 'TG/2023/1780', 'TCS2122', 'QU03', 82.00),

-- ============================================================
-- TG/2023/1781 (Proper - Kamal Fernando) - misses some exams (NULL marks)
-- ============================================================
-- ICT2142
('MK000000048', 'TG/2023/1781', 'ICT2142', 'ASST', 65.00),
('MK000000049', 'TG/2023/1781', 'ICT2142', 'FINT', NULL),  -- missed final
('MK000000050', 'TG/2023/1781', 'ICT2142', 'QU01', 70.00),
('MK000000051', 'TG/2023/1781', 'ICT2142', 'QU02', NULL),  -- missed quiz
('MK000000052', 'TG/2023/1781', 'ICT2142', 'QU03', 68.00),

-- ICT2122
('MK000000053', 'TG/2023/1781', 'ICT2122', 'ASST', 60.00),
('MK000000054', 'TG/2023/1781', 'ICT2122', 'MIDT', 55.00),
('MK000000055', 'TG/2023/1781', 'ICT2122', 'FINT', 62.00),
('MK000000056', 'TG/2023/1781', 'ICT2122', 'QU01', 58.00),
('MK000000057', 'TG/2023/1781', 'ICT2122', 'QU02', 63.00),
('MK000000058', 'TG/2023/1781', 'ICT2122', 'QU03', NULL),  -- missed

-- ICT2132
('MK000000059', 'TG/2023/1781', 'ICT2132', 'ASST', 70.00),
('MK000000060', 'TG/2023/1781', 'ICT2132', 'MIDP', 65.00),
('MK000000061', 'TG/2023/1781', 'ICT2132', 'FINP', NULL),  -- missed final practical
('MK000000062', 'TG/2023/1781', 'ICT2132', 'QU01', 72.00),
('MK000000063', 'TG/2023/1781', 'ICT2132', 'QU02', 68.00),
('MK000000064', 'TG/2023/1781', 'ICT2132', 'QU03', 71.00),

-- ICT2152
('MK000000065', 'TG/2023/1781', 'ICT2152', 'ASST', 58.00),
('MK000000066', 'TG/2023/1781', 'ICT2152', 'MIDT', 52.00),
('MK000000067', 'TG/2023/1781', 'ICT2152', 'FINT', 60.00),
('MK000000068', 'TG/2023/1781', 'ICT2152', 'QU01', 55.00),
('MK000000069', 'TG/2023/1781', 'ICT2152', 'QU02', 57.00),
('MK000000070', 'TG/2023/1781', 'ICT2152', 'QU03', 59.00),

-- ENG2122
('MK000000071', 'TG/2023/1781', 'ENG2122', 'ASST', 72.00),
('MK000000072', 'TG/2023/1781', 'ENG2122', 'MIDT', 68.00),
('MK000000073', 'TG/2023/1781', 'ENG2122', 'FINT', 70.00),
('MK000000074', 'TG/2023/1781', 'ENG2122', 'QU01', 65.00),
('MK000000075', 'TG/2023/1781', 'ENG2122', 'QU02', 67.00),
('MK000000076', 'TG/2023/1781', 'ENG2122', 'QU03', 69.00),

-- ICT2113
('MK000000077', 'TG/2023/1781', 'ICT2113', 'ASST', 55.00),
('MK000000078', 'TG/2023/1781', 'ICT2113', 'MIDP', NULL),  -- missed
('MK000000079', 'TG/2023/1781', 'ICT2113', 'FINT', 58.00),
('MK000000080', 'TG/2023/1781', 'ICT2113', 'QU01', 60.00),
('MK000000081', 'TG/2023/1781', 'ICT2113', 'QU02', 56.00),
('MK000000082', 'TG/2023/1781', 'ICT2113', 'QU03', 62.00),

-- TCS2112
('MK000000083', 'TG/2023/1781', 'TCS2112', 'ASST', 63.00),
('MK000000084', 'TG/2023/1781', 'TCS2112', 'MIDT', 59.00),
('MK000000085', 'TG/2023/1781', 'TCS2112', 'FINT', 65.00),
('MK000000086', 'TG/2023/1781', 'TCS2112', 'QU01', 61.00),
('MK000000087', 'TG/2023/1781', 'TCS2112', 'QU02', 64.00),
('MK000000088', 'TG/2023/1781', 'TCS2112', 'QU03', 62.00),

-- TCS2122
('MK000000089', 'TG/2023/1781', 'TCS2122', 'ASST', 68.00),
('MK000000090', 'TG/2023/1781', 'TCS2122', 'MIDT', 64.00),
('MK000000091', 'TG/2023/1781', 'TCS2122', 'FINT', 66.00),
('MK000000092', 'TG/2023/1781', 'TCS2122', 'QU01', 62.00),
('MK000000093', 'TG/2023/1781', 'TCS2122', 'QU02', NULL),  -- missed
('MK000000094', 'TG/2023/1781', 'TCS2122', 'QU03', 67.00),

-- ============================================================
-- TG/2022/1785 (Repeat - Dinuka Fernando) - 2 courses, low marks (repeat reason)
-- ============================================================
-- ICT2142
('MK000000095', 'TG/2022/1785', 'ICT2142', 'ASST', 45.00),
('MK000000096', 'TG/2022/1785', 'ICT2142', 'FINT', 38.00),
('MK000000097', 'TG/2022/1785', 'ICT2142', 'QU01', 42.00),
('MK000000098', 'TG/2022/1785', 'ICT2142', 'QU02', 40.00),
('MK000000099', 'TG/2022/1785', 'ICT2142', 'QU03', 44.00),

-- TCS2122
('MK000000100', 'TG/2022/1785', 'TCS2122', 'ASST', 50.00),
('MK000000101', 'TG/2022/1785', 'TCS2122', 'MIDT', 43.00),
('MK000000102', 'TG/2022/1785', 'TCS2122', 'FINT', 41.00),
('MK000000103', 'TG/2022/1785', 'TCS2122', 'QU01', 48.00),
('MK000000104', 'TG/2022/1785', 'TCS2122', 'QU02', 46.00),
('MK000000105', 'TG/2022/1785', 'TCS2122', 'QU03', 44.00),

-- ============================================================
-- TG/2021/1790 (Suspended - Supun Silva) - 3 courses, very poor/incomplete marks
-- ============================================================
-- ICT2122
('MK000000106', 'TG/2021/1790', 'ICT2122', 'ASST', 30.00),
('MK000000107', 'TG/2021/1790', 'ICT2122', 'MIDT', NULL),  -- missed
('MK000000108', 'TG/2021/1790', 'ICT2122', 'FINT', 25.00),
('MK000000109', 'TG/2021/1790', 'ICT2122', 'QU01', 35.00),
('MK000000110', 'TG/2021/1790', 'ICT2122', 'QU02', NULL),  -- missed
('MK000000111', 'TG/2021/1790', 'ICT2122', 'QU03', 28.00),

-- ENG2122
('MK000000112', 'TG/2021/1790', 'ENG2122', 'ASST', 40.00),
('MK000000113', 'TG/2021/1790', 'ENG2122', 'MIDT', 32.00),
('MK000000114', 'TG/2021/1790', 'ENG2122', 'FINT', NULL),  -- missed final
('MK000000115', 'TG/2021/1790', 'ENG2122', 'QU01', 38.00),
('MK000000116', 'TG/2021/1790', 'ENG2122', 'QU02', 35.00),
('MK000000117', 'TG/2021/1790', 'ENG2122', 'QU03', NULL),  -- missed

-- ICT2142
('MK000000118', 'TG/2021/1790', 'ICT2142', 'ASST', 28.00),
('MK000000119', 'TG/2021/1790', 'ICT2142', 'FINT', NULL),  -- missed final
('MK000000120', 'TG/2021/1790', 'ICT2142', 'QU01', 33.00),
('MK000000121', 'TG/2021/1790', 'ICT2142', 'QU02', NULL),  -- missed
('MK000000122', 'TG/2021/1790', 'ICT2142', 'QU03', 30.00);
